...
func auto(cmd *cobra.Command, args []string) {
	...
	tables = append(tables, &models.Location{}, &models.Review{}, &models.OrderedItemAttribute{})
	...
	tForeignKeys = append(tForeignKeys, &models.ProductAttribute{}, &models.OrderLog{})
	...
	tForeignKeys = append(tForeignKeys, &models.Review{}, &models.OrderedItemAttribute{})
